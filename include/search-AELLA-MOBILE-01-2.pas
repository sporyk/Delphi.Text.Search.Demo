...
type
     ...
     public
      constructor Create(aParameters:TSearchParameters;aEndOfScan:THandle;aOnNewItemFound:TNotifyEvent=nil);reintroduce;
...
constructor TSearchOperation.Create(aParameters: TSearchParameters;aEndOfScan:THandle; aOnNewItemFound: TNotifyEvent);
var m:WideString;
begin
 inherited Create(True);
 FreeOnTerminate:=true;

 EndOfScan:=aEndOfScan;
...
begin
 ...
 SetEvent(EndOfScan); // report end of the scan
end;
